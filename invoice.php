...
/*
      ...
      {
      ?>
      <h3 align="center">ChalYaara Invoice System</h3>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="print_invoice.php?pdf=1&id='.$row["order_id"].'"><span class= "glyphicon glyphicon-print"</span></a></td>
